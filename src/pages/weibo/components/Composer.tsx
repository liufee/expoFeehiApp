...
import type {Location, Media, Weibo} from '../../../service/weibo/model';
...
export const Composer = ({uid, draftFile, setting, weiboService, repostWeibo = null, onPosted}: Props) => {
    ...
    useEffect(() => {
        (async () => {
            try {
                const draft = await FileSystem.readAsStringAsync(draftFile, {
    ...
    const submitPostAfterSizeCheck = async () => {
        ...
        try {
            await FileSystem.writeAsStringAsync(draftFile, '', {
                encoding: FileSystem.EncodingType.UTF8,
            });
        } catch (e) {}
                    ...
                    <View style={styles.rightControls}>
                        ...
                        <View style={styles.buttonGroup}>
                            <Pressable
                                ...
                                onPress={async () => {
                                    try {
                                        await FileSystem.writeAsStringAsync(draftFile, text, {
                                            encoding: FileSystem.EncodingType.UTF8,
                                        });
